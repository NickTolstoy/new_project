...
const About = () => {
  useEffect(() => {
    document.title = 'О нас - ЭлектроСервис'
    window.scrollTo(0, 0)
  }, [])
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
              <div>
                ...
                <div className="space-y-4">
                  <p className="text-text-secondary">
                    Компания "ЭлектроСервис" была основана в 2018 году группой энтузиастов электромобилей, которые увидели растущую потребность в специализированных сервисах для владельцев электротранспорта.
                  </p>
                  <p className="text-text-secondary">
                  ...
                  <p className="text-text-secondary">
                    Сегодня "ЭлектроСервис" — это команда высококвалифицированных специалистов, которые любят свою работу и постоянно совершенствуют свои навыки. Мы обслуживаем все популярные марки электромобилей и гибридов, предлагая полный спектр услуг: от базовой диагностики до сложного ремонта высоковольтных систем.
                  </p>
                  <p className="text-text-secondary">
              ...
              <div className="relative">
                <img 
                  ...
                  alt="История компании ЭлектроСервис" 
