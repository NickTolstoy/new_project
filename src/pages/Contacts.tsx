...
const Contacts = () => {
  ...
  // Получаем location для доступа к search параметрам и hash
  ...
  useEffect(() => {
    ...
    // Получаем параметр service из URL если он есть
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    try {
      ...
      const formData = {
        ...
        service,
        message,
        formType: 'contact' as 'contact' // Указываем тип формы
      }
      
      // Отправляем форму с использованием API
      const result = await submitContactForm(formData)
      
      if (result.success) {
        console.log('Форма успешно отправлена:', result)
        
        // Сохраняем форму локально для отображения в админке
        const newForm: ContactFormData = {
          id: result.formId?.toString() || Date.now().toString(),
          name,
          phone,
          email,
          carModel,
  ...
  const serviceLabels: Record<string, string> = {
    ...
    'brake-service': 'Обслуживание тормозной системы',
    'battery-service': 'Работа с силовым аккумулятором',
    'transmission': 'Обслуживание трансмиссии',
    'air-conditioning': 'Обслуживание кондиционера',
    'body-repair': 'Кузовные работы',
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
            ...
            <div>
              <motion.div 
                ...
                animate={{ opacity: 1, y: 0 }}
                transition={{ duration: 0.6 }}
                className="glass-card p-8 rounded-xl shadow-lg hover:shadow-xl hover:shadow-accent-blue/10 transition-all duration-300"
                id="form"
              >
                ...
                {isSubmitted ? (
                  <motion.div 
                    ...
                    className="bg-accent-green/10 border border-accent-green/30 rounded-lg p-6 text-center"
                  >
                    <div className="bg-accent-green/20 p-3 rounded-full w-20 h-20 flex items-center justify-center mx-auto mb-4">
                  ...
                  <form onSubmit={handleSubmit}>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                      <div>
                        <label htmlFor="name" className="block text-text-secondary mb-2">Ваше имя *</label>
                        <input
                          type="text"
                          id="name"
                          value={name}
                    ...
                    <div className="mb-6">
                      ...
                      >
                        ...
                        <option value="diagnostics">Компьютерная диагностика</option>
                        <option value="oil-filter">Замена масляного фильтра</option>
                        <option value="brake-service">Обслуживание тормозной системы</option>
                        <option value="battery-service">Работа с силовым аккумулятором</option>
                        <option value="transmission">Обслуживание трансмиссии</option>
                        <option value="air-conditioning">Обслуживание кондиционера</option>
                        <option value="body-repair">Кузовные работы</option>
                        <option value="coolant">Замена антифриза</option>
                    ...
                    <div className="mb-6">
                      <label className="flex items-start">
                        ...
                        <span className="text-sm text-text-secondary">
                          ...
                          <a href="#" className="text-accent-blue hover:text-accent-green transition-colors"> политику конфиденциальности</a>.
                        </span>
                      </label>
                    </div>
            ...
            <div>
              ...
              >
                ...
                >
                  <motion.div variants={item} className="glass-card p-6 rounded-xl shadow-lg hover:shadow-neon transition-all duration-300">
                    <div className="flex items-start">
                      <div className="bg-gradient-to-br from-accent-blue/20 to-accent-green/20 p-3 rounded-full mr-4">
                ...
                <motion.div 
                  ...
                  initial="hidden"
                  animate="show"
                  className="glass-card p-6 rounded-xl mb-10 shadow-lg hover:shadow-xl hover:shadow-accent-blue/10 transition-all duration-300"
                >
                  <div className="flex items-start">
                    <div className="bg-gradient-to-br from-accent-blue/20 to-accent-green/20 p-3 rounded-full mr-4 mt-1">
                      <svg className="w-6 h-6 text-accent-blue" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div>
                      ...
                      <p className="text-text-secondary">
                        ...
                        <span className="bg-bg-secondary/50 text-sm px-3 py-1 rounded-full inline-block mt-1 mr-2">Пн-Пт: 9:00 - 21:00</span>
                        <span className="bg-bg-secondary/50 text-sm px-3 py-1 rounded-full inline-block mt-1">Сб-Вс: 10:00 - 20:00</span>
                      </p>
                    </div>
                  </div>
                </motion.div>
                ...
                <motion.div 
                  ...
                  initial="hidden"
                  animate="show" 
                  className="glass-card p-6 rounded-xl mb-6 shadow-lg hover:shadow-neon transition-all duration-300"
                >
                  <h3 className="font-bold mb-4">Мы в социальных сетях</h3>
                  <div className="flex space-x-4">
                    <a href="#" className="bg-gradient-to-br from-accent-blue/20 to-accent-green/20 p-3 rounded-full text-text-secondary hover:text-accent-blue hover:scale-110 transition-all duration-300">
      ...
      <section className="py-8 pb-16">
        <div className="container">
          <motion.div 
            ...
            className="glass-card rounded-xl overflow-hidden p-2 shadow-xl hover:shadow-2xl hover:shadow-accent-blue/10 transition-all duration-500"
          >
            ...
            <div className="aspect-video bg-bg-secondary/80 rounded-lg flex items-center justify-center">
              <div className="text-center">
                <div className="bg-gradient-to-br from-accent-blue/20 to-accent-green/20 p-4 rounded-full w-24 h-24 flex items-center justify-center mx-auto mb-4">
                ...
                <p className="text-text-secondary">
                  ...
                  <span className="bg-bg-secondary/50 text-sm px-3 py-1 rounded-full inline-block mt-2">Москва, ул. Электрозаводская, 27с1A</span>
                </p>
              </div>
            </div>
          </motion.div>
